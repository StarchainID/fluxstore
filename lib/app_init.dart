...
class _AppInitState extends BaseScreen<AppInit> {
  ...
  bool checkLogin() {
    final hasLogin = injector<SharedPreferences>().getBool(LocalStorageKey.loggedIn);
    ...
    try {
      ...
      Future.delayed(
        ...
        () {
          ...
          Provider.of<FilterAttributeModel>(context, listen: false).getFilterAttributes();
          ...
          if (Config().isListingType) {
            Provider.of<ListingLocationModel>(context, listen: false).getLocations();
          }
