...
import '../models/index.dart'
    show AppModel, BackDropArguments, BlogModel, Product, ProductModel, SearchModel, User;
...
class Routes {
    ...
    switch (routingData.route) {
        ...
        return _buildRoute(
          ...
          (_) => ChangeNotifierProvider<ListOrderHistoryModel>(
            create: (context) => ListOrderHistoryModel(
              repository: ListOrderRepository(user: user == null ? User() : user as User),
            ),
      ...
      case RouteList.vendors:
        ...
        if (data is TabBarMenuConfig) {
          return _buildRoute(
            settings,
            (context) => Services().widget.renderVendorCategoriesScreen(data.jsonData),
          );
        }
        return _errorRoute();
      case RouteList.map:
  ...
  static MaterialPageRoute _buildRoute(RouteSettings settings, WidgetBuilder builder,
