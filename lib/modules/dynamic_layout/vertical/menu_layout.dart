...
import '../../../models/index.dart' show AppModel, Category, CategoryModel, Product, UserModel;
...
class _StateMenuLayout extends State<MenuLayout> {
  ...
  List<Category>? getAllCategory() {
    final categories = Provider.of<CategoryModel>(context, listen: true).categories;
