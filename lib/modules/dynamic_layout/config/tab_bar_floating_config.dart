...
FloatingActionButtonLocation? stringToFloatingActionButtonLocation(String? value) {
  switch (value) {
    case 'centerDocked':
...
String? floatingActionButtonLocationToString(FloatingActionButtonLocation? value) {
  switch (value) {
...
String floatingTypeToString(FloatingType value) => value.toString().split('.').last;
