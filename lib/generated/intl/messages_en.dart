...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(month) => "${month} months ago";

  static String m10(itemCount) => "${itemCount} items";

  static String m11(price) => "Options total: ${price}";
  ...
  static String m16(total) => "${total} products";

  static String m17(date) => "Valid til ${date}";

  static String m18(message) => "Warning: ${message}";

  static String m19(length) => "We found ${length} products";

  static String m20(week) => "Week ${week}";

  static String m21(year) => "${year} years ago";
