...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(timeLeft) => "Eindigt over ${timeLeft}";

  static String m3(message) => "Fout: ${message}";

  static String m4(time) => "Verloopt over ${time}";

  static String m5(hour) => "${hour} uur geleden";
  ...
  static String m7(size) => "Maximale bestandsgrootte: ${size} MB";

  static String m8(minute) => "${minute} minuten geleden";

  static String m9(month) => "${month} maanden geleden";

  static String m10(itemCount) => "${itemCount} items";

  static String m11(price) => "Opties totaal: ${price}";

  static String m12(percent) => "Verkoop ${percent} %";

  static String m13(second) => "${second} seconden geleden";

  static String m14(totalCartQuantity) =>
      "Winkelwagen, ${totalCartQuantity} artikelen";

  static String m15(numberOfUnitsSold) => "Verkocht: ${numberOfUnitsSold}";

  static String m16(total) => "${total} producten";

  static String m17(date) => "Geldig tot ${date}";

  static String m18(message) => "Waarschuwing: ${message}";

  static String m19(length) => "We hebben ${length} producten gevonden";

  static String m20(week) => "Week ${week}";

  static String m21(year) => "${year} jaar geleden";
