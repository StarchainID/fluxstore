...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(message) => "Errore: ${message}";

  static String m4(time) => "In scadenza tra ${time}";
  ...
  static String m7(size) => "Dimensione massima del file: ${size} MB";

  static String m8(minute) => "${minute} minutes ago";

  static String m9(month) => "${month} mesi fa";

  static String m10(itemCount) => "${itemCount} items";

  static String m11(price) => "Opzioni totali: ${price}";

  static String m12(percent) => "${percent}% di sconto";

  static String m13(second) => "${second} seconds ago";
  ...
  static String m16(total) => "${total} Prodotti";

  static String m17(date) => "Valido fino alle ${date}";

  static String m18(message) => "Warning: ${message}";

  static String m19(length) => "Abbiamo trovato \$length prodotti";

  static String m20(week) => "Settimana ${week}";

  static String m21(year) => "${year} anni fa";
