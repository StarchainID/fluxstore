...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(timeLeft) => "Kończy się za ${timeLeft}";

  static String m3(message) => "Błąd: ${message}";

  static String m4(time) => "Wygasa za ${time}";

  static String m5(hour) => "${hour} godz. Temu";
  ...
  static String m7(size) => "Maksymalny rozmiar pliku: ${size} MB";

  static String m8(minute) => "${minute} min temu";

  static String m9(month) => "${month} miesięcy temu";

  static String m10(itemCount) => "${itemCount} elementów";

  static String m11(price) => "Łącznie opcje: ${price}";

  static String m12(percent) => "Wyprzedaż ${percent}%";

  static String m13(second) => "${second} sekundy temu";

  static String m14(totalCartQuantity) =>
      "Koszyk, ${totalCartQuantity} pozycje";

  static String m15(numberOfUnitsSold) => "Sprzedane: ${numberOfUnitsSold}";

  static String m16(total) => "${total} produktów";

  static String m17(date) => "Ważne do ${date}";

  static String m18(message) => "Ostrzeżenie: ${message}";

  static String m19(length) => "Znaleźliśmy ${length} produktów";

  static String m20(week) => "Tydzień ${week}";

  static String m21(year) => "${year} lat temu";
