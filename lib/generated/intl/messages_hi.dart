...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(month) => "${month} महीने पहले";

  static String m10(itemCount) => "${itemCount} आइटम";

  static String m11(price) => "विकल्प कुल: ${price}";

  static String m12(percent) => "बिक्री ${percent} %";

  static String m13(second) => "${second} सेकंड पहले";

  static String m14(totalCartQuantity) =>
      "शॉपिंग कार्ट, ${totalCartQuantity} आइटम";

  static String m15(numberOfUnitsSold) => "बिक गया: ${numberOfUnitsSold}";

  static String m16(total) => "${total} उत्पाद";

  static String m17(date) => "मान्य तिल ${date}";

  static String m18(message) => "चेतावनी: ${message}";

  static String m19(length) => "हमें ${length} उत्पाद मिले";

  static String m20(week) => "सप्ताह ${week}";

  static String m21(year) => "${year} साल पहले";
