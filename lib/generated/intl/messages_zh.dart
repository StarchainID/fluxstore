...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(month) => "${month} 个月前";

  static String m10(itemCount) => "${itemCount} items";

  static String m11(price) => "选项总数： ${price}";

  static String m12(percent) => "出售${percent}%";
  ...
  static String m15(numberOfUnitsSold) => "已售出： ${numberOfUnitsSold}";

  static String m16(total) => "${total} 个产品";

  static String m17(date) => "有效期至 ${date}";

  static String m18(message) => "Warning: ${message}";

  static String m19(length) => "我們找到 ${length} 個產品";

  static String m20(week) => "周 ${week}";
