...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(month) => "${month} 개월 전";

  static String m10(itemCount) => "${itemCount} 항목";

  static String m11(price) => "총 옵션 : ${price}";

  static String m12(percent) => "판매 ${percent} %";

  static String m13(second) => "${second} 초 전";

  static String m14(totalCartQuantity) => "장바구니, ${totalCartQuantity} 개 항목";

  static String m15(numberOfUnitsSold) => "판매 : ${numberOfUnitsSold}";

  static String m16(total) => "${total} 제품";

  static String m17(date) => " ${date}까지 유효";

  static String m18(message) => "경고 : ${message}";

  static String m19(length) => " ${length} 개의 제품을 찾았습니다.";

  static String m20(week) => "주 ${week}";

  static String m21(year) => "${year} 년 전";
