...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(message) => "Ошибка: ${message}";

  static String m4(time) => "Срок действия истекает через ${time}";

  static String m5(hour) => "${hour} часов назад";
  ...
  static String m7(size) => "Максимальный размер файла: ${size} МБ";

  static String m8(minute) => "${minute} минут назад";

  static String m9(month) => "${month} месяцев назад";

  static String m10(itemCount) => "${itemCount} товаров";

  static String m11(price) => "Всего вариантов: ${price}";

  static String m12(percent) => "Распродажа ${percent} %";

  static String m13(second) => "${second} секунд назад";

  static String m14(totalCartQuantity) =>
      "Корзина, ${totalCartQuantity} товаров";

  static String m15(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m16(total) => "${total} продуктов";

  static String m17(date) => "Действительно до ${date}";

  static String m18(message) => "Предупреждение: ${message}";

  static String m19(length) => "Мы нашли товары";

  static String m20(week) => "Неделя ${week}";

  static String m21(year) => "${year} лет назад";
