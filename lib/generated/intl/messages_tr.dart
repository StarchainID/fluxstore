...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(month) => "${month} ay önce";

  static String m10(itemCount) => "${itemCount} ürün";

  static String m11(price) => "Toplam seçenek: ${price}";

  static String m12(percent) => "% ${percent} İndirim ";

  static String m13(second) => "${second} Saniye önce";

  static String m14(totalCartQuantity) => "${totalCartQuantity} ürün, Sepette";

  static String m15(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m16(total) => "${total} ürün";

  static String m17(date) => " ${date}tarihine kadar geçerlidir";

  static String m18(message) => "Hata: ${message}";

  static String m19(length) => " \$${length} Ürün Bulundu";

  static String m20(week) => " ${week}haftası";

  static String m21(year) => "${year} yıl önce";
