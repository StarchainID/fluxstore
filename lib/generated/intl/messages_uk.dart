...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(timeLeft) => "Закінчується через ${timeLeft}";

  static String m3(message) => "Помилка: ${message}";

  static String m4(time) => "Термін дії закінчується через ${time}";

  static String m5(hour) => "${hour} годин тому";
  ...
  static String m7(size) => "Максимальний розмір файлу: ${size} МБ";

  static String m8(minute) => "${minute} хвилин тому";

  static String m9(month) => "${month} місяців тому";

  static String m10(itemCount) => "${itemCount} елементів";

  static String m11(price) => "Всього варіантів: ${price}";

  static String m12(percent) => "Продаж ${percent}%";

  static String m13(second) => "${second} секунд тому";

  static String m14(totalCartQuantity) =>
      "Кошик, товарів: ${totalCartQuantity} ";

  static String m15(numberOfUnitsSold) => "Продано: ${numberOfUnitsSold}";

  static String m16(total) => "${total} продуктів";

  static String m17(date) => "Діє до ${date}";

  static String m18(message) => "Попередження: ${message}";

  static String m19(length) => "Ми знайшли ${length} продуктів";

  static String m20(week) => "Тиждень ${week}";

  static String m21(year) => "${year} років тому";
