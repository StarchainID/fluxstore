...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(message) => "Erro: ${message}";

  static String m4(time) => "Expirando em ${time}";

  static String m5(hour) => "${hour} horas atrás";
  ...
  static String m7(size) => "Tamanho máximo do arquivo: ${size} MB";

  static String m8(minute) => "${minute} minutos atrás";

  static String m9(month) => "${month} meses atrás";

  static String m10(itemCount) => "${itemCount} itens";

  static String m11(price) => "Opções totais: ${price}";

  static String m12(percent) => "Desconto ${percent} %";

  static String m13(second) => "${second} segundos atrás";
  ...
  static String m16(total) => "${total} produtos";

  static String m17(date) => "Válido até ${date}";

  static String m18(message) => "Atenção: ${message}";

  static String m19(length) => "Encontramos ${length} produtos";

  static String m20(week) => "Semana ${week}";

  static String m21(year) => "${year} anos atrás";
