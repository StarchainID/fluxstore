...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(timeLeft) => "Завршава се у${timeLeft}";

  static String m3(message) => "Fehler: ${message}";

  static String m4(time) => "Истиче ${time}";

  static String m5(hour) => "Пре ${hour} Сати";
  ...
  static String m8(minute) => "Пре ${minute} Minuten";

  static String m10(itemCount) => "${itemCount} Ставка";

  static String m11(price) => "Укупно опција: ${price}";

  static String m12(percent) => "Распродај ${percent} %";

  static String m13(second) => "Пре ${second} Минута";

  static String m14(totalCartQuantity) =>
      "корпа, ${totalCartQuantity} предмета";

  static String m15(numberOfUnitsSold) => "продато: ${numberOfUnitsSold}";

  static String m17(date) => "Датум истека ${date}";

  static String m18(message) => "упозорење: ${message}";

  static String m19(length) => "Пронашли смо производе";
