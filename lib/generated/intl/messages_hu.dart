...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(month) => "${month} hónappal ezelőtt";

  static String m10(itemCount) => "${itemCount} termékek";

  static String m11(price) => "Opciók összesen: ${price}";

  static String m12(percent) => "${percent} % Kedvezmény";

  static String m13(second) => "${second} másodperce";
  ...
  static String m16(total) => "${total} termék";

  static String m17(date) => "Érvényes: ${date}";

  static String m18(message) => "Figyelmeztetés: ${message}";

  static String m19(length) => "Találtunk ${length} terméket";

  static String m20(week) => " ${week}hét";

  static String m21(year) => "${year} évvel ezelőtt";
