...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(timeLeft) => "Slutar om ${timeLeft}";

  static String m3(message) => "Fel: ${message}";

  static String m4(time) => "Går ut om ${time}";

  static String m5(hour) => "${hour} timmar sedan";
  ...
  static String m7(size) => "Maximal filstorlek: ${size} MB";

  static String m8(minute) => " För${minute} minuter sedan";

  static String m9(month) => "${month} månader sedan";

  static String m10(itemCount) => "${itemCount} objekt";

  static String m11(price) => "Totalt antal alternativ: ${price}";

  static String m12(percent) => "Försäljning ${percent}%";

  static String m13(second) => " För${second} sekunder sedan";

  static String m14(totalCartQuantity) =>
      "Kundvagn, ${totalCartQuantity} artiklar";

  static String m15(numberOfUnitsSold) => "Såld: ${numberOfUnitsSold}";

  static String m16(total) => "${total} produkter";

  static String m17(date) => "Gäller till ${date}";

  static String m18(message) => "Varning: ${message}";

  static String m19(length) => "Vi hittade ${length} produkter";

  static String m20(week) => "Vecka ${week}";

  static String m21(year) => " För${year} år sedan";
