...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(time) => "Expiră în ${time}";
  ...
  static String m7(size) => "Dimensiunea maximă a fișierului: ${size} MB";

  static String m8(minute) => "${minute} minutes ago";

  static String m9(month) => " Acum${month} luni";

  static String m10(itemCount) => "${itemCount} items";

  static String m11(price) => "Opțiuni totale: ${price}";

  static String m12(percent) => "Reducere ${percent} %";
  ...
  static String m16(total) => "${total} produse";

  static String m17(date) => "Valabil până la ${date}";

  static String m18(message) => "Warning: ${message}";

  static String m19(length) => "Am gasit ${length} produse";

  static String m20(week) => "Săptămâna ${week}";

  static String m21(year) => " Acum${year} ani";
