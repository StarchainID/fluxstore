...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(time) => " ${time}で期限切れ";
  ...
  static String m7(size) => "最大ファイルサイズ： ${size} MB";

  static String m8(minute) => "${minute} minutes ago";

  static String m9(month) => "${month} か月前";

  static String m10(itemCount) => "${itemCount} items";

  static String m11(price) => "オプションの合計： ${price}";

  static String m12(percent) => "セール${percent}％";
  ...
  static String m16(total) => "${total} 製品";

  static String m17(date) => " ${date}まで有効";

  static String m18(message) => "Warning: ${message}";

  static String m19(length) => "${length} 個の商品が見つかりました";

  static String m20(week) => "週 ${week}";

  static String m21(year) => "${year} 年前";
