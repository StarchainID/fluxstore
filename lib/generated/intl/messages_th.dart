...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(month) => "${month} เดือนที่แล้ว";

  static String m10(itemCount) => "${itemCount} รายการ";

  static String m11(price) => "ตัวเลือกทั้งหมด: ${price}";

  static String m12(percent) => "ยอดขาย ${percent} %";

  static String m13(second) => "${second} วินาทีที่ผ่านมา";

  static String m14(totalCartQuantity) => "รถเข็นชอปปิ้งไอเท็ม ";

  static String m15(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m16(total) => "${total} ผลิตภัณฑ์";

  static String m17(date) => "ใช้ได้จนถึง ${date}";

  static String m18(message) => "คำเตือน: ${message}";

  static String m19(length) => "เราพบสินค้า ${length}";

  static String m20(week) => "สัปดาห์ ${week}";

  static String m21(year) => "${year} ปีที่แล้ว";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "emptyComment": MessageLookupByLibrary.simpleMessage(
            "ความคิดเห็นของคุณต้องไม่ว่างเปล่า"),
        ...
        "orderStatusProcessed":
            MessageLookupByLibrary.simpleMessage("แปรรูปแล้ว"),
        "orderStatusProcessing":
            MessageLookupByLibrary.simpleMessage("กำลังประมวลผล"),
        "orderStatusRefunded":
            MessageLookupByLibrary.simpleMessage("สถานะ Refunded"),
        "orderStatusReversed": MessageLookupByLibrary.simpleMessage("กลับด้าน"),
        "orderStatusShipped":
