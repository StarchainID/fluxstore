...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(month) => " قبل${month} شهر";

  static String m10(itemCount) => "${itemCount} عنصر";

  static String m11(price) => "إجمالي الخيارات: ${price}";

  static String m12(percent) => "بيع ${percent} ٪";

  static String m13(second) => "${second} ثواني ماضية";
  ...
  static String m16(total) => "${total} من المنتجات";

  static String m17(date) => "صالح حتى ${date}";

  static String m18(message) => "تحذير: ${message}";

  static String m19(length) => "وجدنا منتجات ${length}";

  static String m20(week) => "الأسبوع ${week}";

  static String m21(year) => " قبل${year} سنة";
