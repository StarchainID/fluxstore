...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(month) => " לפני${month} חודשים";

  static String m10(itemCount) => "${itemCount} פריטים";

  static String m11(price) => "סה\"כ אפשרויות: ${price}";

  static String m12(percent) => "הנחה ${percent}%";

  static String m13(second) => "לפני ${second} שניות";

  static String m14(totalCartQuantity) =>
      "עגלת קניות, ${totalCartQuantity} פריטים";

  static String m15(numberOfUnitsSold) => "נמכר: ${numberOfUnitsSold}";

  static String m16(total) => "${total} מוצרים";

  static String m17(date) => "תקף עד ${date}";

  static String m18(message) => "אזהרה: ${message}";

  static String m19(length) => "מצאנו ${length} מוצרים";

  static String m20(week) => "שבוע ${week}";

  static String m21(year) => " לפני${year} שנים";
