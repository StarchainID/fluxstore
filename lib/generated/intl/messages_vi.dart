...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(month) => "${month} tháng trước";

  static String m10(itemCount) => "${itemCount} items";

  static String m11(price) => "Tổng số tùy chọn: ${price}";

  static String m12(percent) => "Sale ${percent} %";
  ...
  static String m15(numberOfUnitsSold) => "Đã bán: ${numberOfUnitsSold}";

  static String m16(total) => "${total} sản phẩm";

  static String m17(date) => "Có hiệu lực cho đến ${date}";

  static String m18(message) => "Warning: ${message}";

  static String m19(length) => "Chúng tôi tìm thấy ${length} sản phẩm";

  static String m20(week) => "Tuần ${week}";

  static String m21(year) => "${year} năm trước";
