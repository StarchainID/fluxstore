...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(time) => "Expirant dans ${time}";

  static String m5(hour) => "il y a ${hour} heures";
  ...
  static String m7(size) => "Taille maximale du fichier: ${size} Mo";

  static String m8(minute) => "il y a ${minute} minutes";

  static String m9(month) => " Il y a${month} mois";

  static String m10(itemCount) => "${itemCount} produits";

  static String m11(price) => "Total des options: ${price}";

  static String m12(percent) => "Vente ${percent} %";

  static String m13(second) => "il y a ${second} secondes";
  ...
  static String m16(total) => "${total} Produits";

  static String m17(date) => "Valable jusqu\'au ${date}";

  static String m18(message) => "Warning: ${message}";

  static String m19(length) => "Nous avons trouvé des ${length} produits";

  static String m20(week) => "Semaine ${week}";

  static String m21(year) => " Il y a${year} ans";
