...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(timeLeft) => "Endet in ${timeLeft}";

  static String m3(message) => "Fehler: ${message}";

  static String m4(time) => "Ablaufen in ${time}";

  static String m5(hour) => "Vor ${hour} Stunden";
  ...
  static String m7(size) => "Maximale Dateigröße: ${size} MB";

  static String m8(minute) => "Vor ${minute} Minuten";

  static String m9(month) => " Vor${month} Monaten";

  static String m10(itemCount) => "${itemCount} Artikel";

  static String m11(price) => "Optionen insgesamt: ${price}";

  static String m12(percent) => "Ausverkauf ${percent} %";

  static String m13(second) => "Vor ${second} Sekunden";

  static String m14(totalCartQuantity) =>
      "Warenkorb, ${totalCartQuantity} Artikel";

  static String m15(numberOfUnitsSold) => "Verkauft: ${numberOfUnitsSold}";

  static String m16(total) => "${total} Produkte";

  static String m17(date) => "Gültig bis ${date}";

  static String m18(message) => "Warnung: ${message}";

  static String m19(length) => "Wir haben die Produkte gefunden";

  static String m20(week) => "Woche ${week}";

  static String m21(year) => " Vor${year} Jahren";
