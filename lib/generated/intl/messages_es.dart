...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(month) => " Hace${month} meses";

  static String m10(itemCount) => "${itemCount} items";

  static String m11(price) => "Total de opciones: ${price}";

  static String m12(percent) => "Rebaja ${percent} %";

  static String m13(second) => "${second} segundos";
  ...
  static String m16(total) => "${total} Productos";

  static String m17(date) => "Válido hasta ${date}";

  static String m18(message) => "Advertencia: ${message}";

  static String m19(length) => "Encontramos productos de ${length}";

  static String m20(week) => "Semana ${week}";

  static String m21(year) => " Hace${year} años";
