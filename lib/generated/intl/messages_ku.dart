...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m10(itemCount) => "${itemCount} ئایتم";

  static String m11(price) => "کۆى گشتى هەڵبژاردنەکان: ${price}";

  static String m12(percent) => "داشکاندن ${percent} %";

  static String m13(second) => "${second} چرکە پێش ئێستا";
  ...
  static String m16(total) => "${total} بەرهەمەکان";

  static String m17(date) => "گونجاوە تا ${date}";

  static String m18(message) => "ئاگاداری: ${message}";

  static String m19(length) => "${length} بەرهەم دۆزرایەوە";
