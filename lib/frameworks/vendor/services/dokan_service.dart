...
class DokanService extends WooCommerceService {
  ...
  Future<List<Store>> getNearbyStores(Prediction prediction) async {
    ...
    try {
      ...
      // var response = await wcApi.getAsync("flutter/get-nearby-stores?distance=${kAdvanceConfig['QueryRadiusDistance']}&latitude=${prediction.lat}&longitude=${prediction.long}");

      var response = await wcApi.getAsync(
          'flutter/get-nearby-stores?latitude=${prediction.lat}&longitude=${prediction.long}');
